...
; Characteristics of each move.
	...
	move MEGA_PUNCH,   NO_ADDITIONAL_EFFECT,        80, NORMAL,       100, 15
	move PAY_DAY,      PAY_DAY_EFFECT,              60, NORMAL,       100, 20
	move FIRE_PUNCH,   BURN_SIDE_EFFECT1,           70, FIRE,         100, 15
	move ICE_PUNCH,    FREEZE_SIDE_EFFECT1,         70, ICE,          100, 15
	...
	move CUT,          NO_ADDITIONAL_EFFECT,        80, BUG,          100, 30
	...
	move SLAM,         FLINCH_SIDE_EFFECT2,        80, DRAGON,        100, 20
	...
	move EARTHQUAKE,   NO_ADDITIONAL_EFFECT,       120, GROUND,       100, 10
	...
	move NIGHT_SHADE,  ATTACK_UP1_EFFECT,           60, GHOST,        100, 15
	move MIMIC,        MIMIC_EFFECT,                 0, NORMAL,       100, 10
	move SCREECH,      DEFENSE_DOWN2_EFFECT,         0, NORMAL,        85, 40
	move DOUBLE_TEAM,  EVASION_UP1_EFFECT,           0, NORMAL,       100, 15
	move RECOVER,      HEAL_EFFECT,                  0, NORMAL,       100, 20
	move HARDEN,       DEFENSE_UP2_EFFECT,           0, NORMAL,       100, 30
	move MINIMIZE,     EVASION_UP1_EFFECT,           0, NORMAL,       100, 20
	move SMOKESCREEN,  ACCURACY_DOWN1_EFFECT,        0, NORMAL,       100, 20
	move CONFUSE_RAY,  CONFUSION_EFFECT,             0, GHOST,        100, 10
	move WITHDRAW,     DEFENSE_UP1_EFFECT,          40, WATER,        100, 40
	move DEFENSE_CURL, DEFENSE_UP2_EFFECT,           0, NORMAL,       100, 40
